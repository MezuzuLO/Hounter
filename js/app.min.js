...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_function_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/function.js */ \"./src/js/modules/function.js\");\n/* harmony import */ var _modules_swiper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/swiper.js */ \"./src/js/modules/swiper.js\");\n/* harmony import */ var _modules_headerNavMenu_open_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/headerNavMenu-open.js */ \"./src/js/modules/headerNavMenu-open.js\");\n/* harmony import */ var _modules_adaptive_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/adaptive.js */ \"./src/js/modules/adaptive.js\");\n/* harmony import */ var _modules_burger_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/burger.js */ \"./src/js/modules/burger.js\");\n/* harmony import */ var _modules_featuresType_select_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/featuresType-select.js */ \"./src/js/modules/featuresType-select.js\");\n/* harmony import */ var _modules_videoPlay_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/videoPlay.js */ \"./src/js/modules/videoPlay.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n_modules_function_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\r\n\r\nconsole.log('hello')\n\n//# sourceURL=webpack://gulp-2022/./src/js/app.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n$(function () {\r\n\ttry {\r\n\t\t// перевірка на наявність елемента\r\n\t\t$('.adaptive-element').each((index) => {\r\n\t\t\t//перевірка\r\n\t\t\tconsole.log('елемент дійсний в ' + $('.adaptive-element').eq(index).attr('class').split(' ')[0] + '')\r\n\t\t\t// обявлення\r\n\t\t\tconst adaptiveValueBlock = $('.adaptive-element').eq(index).attr('data-adaptiveValue').split(' ')[0]\r\n\t\t\tconst adaptiveValueMedia = $('.adaptive-element').eq(index).attr('data-adaptiveValue').split(' ')[1]\r\n\t\t\tconst adaptiveValueNumber = $('.adaptive-element').eq(index).attr('data-adaptiveValue').split(' ')[2]\r\n\t\t\t// провірка відповідності медіа\r\n\t\t\tif ($(window).width() <= parseInt(adaptiveValueMedia)) {\r\n\t\t\t\t//перевірка\r\n\t\t\t\tconsole.log('медіа дійсна в ' + adaptiveValueMedia + '')\r\n\t\t\t\t// провірка відповідності блока\r\n\t\t\t\tif ($('.adaptive-element').eq(index).attr('data-adaptiveValue').split(' ')[0] === adaptiveValueBlock) {\r\n\t\t\t\t\t//перевірка\r\n\t\t\t\t\tconsole.log('блок дійсний в ' + adaptiveValueBlock + '')\r\n\t\t\t\t\t// провірка відповідності ордера\r\n\t\t\t\t\tif ($('.adaptive-element').eq(index).attr('data-adaptiveValue').split(' ')[2] === adaptiveValueNumber) {\r\n\t\t\t\t\t\t//перевірка\r\n\t\t\t\t\t\tconsole.log('ордер дійсний в ' + adaptiveValueNumber + '')\r\n\t\t\t\t\t\t// якщо ордер = 0\r\n\t\t\t\t\t\tif (parseInt(adaptiveValueNumber) === 0) {\r\n\t\t\t\t\t\t\t$(`.${adaptiveValueBlock}`).prepend($('.adaptive-element')).eq(index)\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t\t// якщо ордер = 1\r\n\t\t\t\t\t\telse if (parseInt(adaptiveValueNumber) >= 1) {\r\n\t\t\t\t\t\t\t$('.adaptive-element').eq(index).insertAfter($(`.${adaptiveValueBlock}__element`).eq(adaptiveValueNumber - 1))\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t\t// якщо ордер = first або last\r\n\t\t\t\t\t\telse if (adaptiveValueNumber === 'first' || 'last') {\r\n\t\t\t\t\t\t\tif (adaptiveValueNumber === 'first') {\r\n\t\t\t\t\t\t\t\t$(`.${adaptiveValueBlock}`).prepend($('.adaptive-element').eq(index))\r\n\t\t\t\t\t\t\t}\r\n\t\t\t\t\t\t\tif (adaptiveValueNumber === 'last') {\r\n\t\t\t\t\t\t\t\t$(`.${adaptiveValueBlock}`).append($('.adaptive-element').eq(index))\r\n\t\t\t\t\t\t\t}\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t\telse {}\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\r\n\t\t\t}\r\n\t\t})\r\n\t}\r\n\tcatch {\r\n\t\t// перевірка на наявність елемента\r\n\t\tif ($('.adaptive-element').attr('data-adaptiveValue') !== undefined) {\r\n\t\t\t//перевірка\r\n\t\t\tconsole.log('елемент дійсний в ' + $('.adaptive-element').attr('class').split(' ')[0] + '')\r\n\t\t\t// обявлення\r\n\t\t\tconst adaptiveValueBlock = $('.adaptive-element').attr('data-adaptiveValue').split(' ')[0]\r\n\t\t\tconst adaptiveValueMedia = $('.adaptive-element').attr('data-adaptiveValue').split(' ')[1]\r\n\t\t\tconst adaptiveValueNumber = $('.adaptive-element').attr('data-adaptiveValue').split(' ')[2]\r\n\t\t\t// провірка відповідності медіа\r\n\t\t\tif ($(window).width() <= parseInt(adaptiveValueMedia)) {\r\n\t\t\t\t//перевірка\r\n\t\t\t\tconsole.log('медіа дійсна в ' + adaptiveValueMedia + '')\r\n\t\t\t\t// провірка відповідності блока\r\n\t\t\t\tif ($('.adaptive-element').attr('data-adaptiveValue').split(' ')[0] === adaptiveValueBlock) {\r\n\t\t\t\t\t//перевірка\r\n\t\t\t\t\tconsole.log('блок дійсний в ' + adaptiveValueBlock + '')\r\n\t\t\t\t\t// провірка відповідності ордера\r\n\t\t\t\t\tif ($('.adaptive-element').attr('data-adaptiveValue').split(' ')[2] === adaptiveValueNumber) {\r\n\t\t\t\t\t\t//перевірка\r\n\t\t\t\t\t\tconsole.log('ордер дійсний в ' + adaptiveValueNumber + '')\r\n\t\t\t\t\t\t// якщо ордер = 0\r\n\t\t\t\t\t\tif (parseInt(adaptiveValueNumber) === 0) {\r\n\t\t\t\t\t\t\t$(`.${adaptiveValueBlock}`).prepend($('.adaptive-element'))\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t\t// якщо ордер = 1\r\n\t\t\t\t\t\telse if (parseInt(adaptiveValueNumber) >= 1) {\r\n\t\t\t\t\t\t\t$('.adaptive-element').eq(0).insertAfter($(`.${adaptiveValueBlock}__element`).eq(adaptiveValueNumber - 1))\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t\t// якщо ордер = first або last\r\n\t\t\t\t\t\telse if (adaptiveValueNumber === 'first' || 'last') {\r\n\t\t\t\t\t\t\tif (adaptiveValueNumber === 'first') {\r\n\t\t\t\t\t\t\t\t$(`.${adaptiveValueBlock}`).prepend($('.adaptive-element'))\r\n\t\t\t\t\t\t\t}\r\n\t\t\t\t\t\t\tif (adaptiveValueNumber === 'last') {\r\n\t\t\t\t\t\t\t\t$(`.${adaptiveValueBlock}`).append($('.adaptive-element'))\r\n\t\t\t\t\t\t\t}\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t\telse {}\r\n\t\t\t\t\t}\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t}\r\n\t}\r\n})\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/adaptive.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n$(function () {\r\n\t$('.burger-menu').slideUp(0)\r\n\t$('.burger-menu-blockmenu').slideUp(0)\r\n\tlet headerBurgerClicks = 0\r\n\tlet headerBurgerMenuClicks = 0\r\n\t$('.burger').click(() => {\r\n\t\theaderBurgerClicks++\r\n\t\tif (headerBurgerClicks === 1) {\r\n\t\t\t$('.burger-menu').slideDown(200)\r\n\t\t\t$('.burger__line:nth-child(2)').fadeOut(200)\r\n\t\t\t$('.burger__line:first-child').css({\r\n\t\t\t\t'transition': 'transform 0.2s linear, top 0.2s linear',\r\n\t\t\t\t'transform': 'rotate(40deg)',\r\n\t\t\t\t'top': '6px'\r\n\t\t\t})\r\n\t\t\t$('.burger__line:last-child').css({\r\n\t\t\t\t'transition': 'transform 0.2s linear, bottom 0.2s linear',\r\n\t\t\t\t'transform': 'rotate(-40deg)',\r\n\t\t\t\t'bottom': '6px'\r\n\t\t\t})\r\n\t\t}\r\n\t\tif (headerBurgerClicks === 2) {\r\n\t\t\t$('.burger-menu').slideUp(200)\r\n\t\t\t$('.burger__line:nth-child(2)').fadeIn(200)\r\n\t\t\t$('.burger__line:first-child').css({\r\n\t\t\t\t'transition': 'transform 0.2s linear, top 0.2s linear',\r\n\t\t\t\t'transform': 'rotate(0deg)',\r\n\t\t\t\t'top': '0px'\r\n\t\t\t})\r\n\t\t\t$('.burger__line:last-child').css({\r\n\t\t\t\t'transition': 'transform 0.2s linear, bottom 0.2s linear',\r\n\t\t\t\t'transform': 'rotate(0deg)',\r\n\t\t\t\t'bottom': '0px'\r\n\t\t\t})\r\n\t\t\theaderBurgerClicks = 0\r\n\t\t\t$('.burger-menu-blockmenu').slideUp(200)\r\n\t\t\theaderBurgerMenuClicks = 0\r\n\t\t}\r\n\t})\r\n\t$('.burger-menu__text-menu').click(() => {\r\n\t\theaderBurgerMenuClicks++\r\n\t\tif (headerBurgerMenuClicks === 1) {\r\n\t\t\t$('.burger-menu-blockmenu').slideDown(200)\r\n\t\t}\r\n\t\tif (headerBurgerMenuClicks === 2) {\r\n\t\t\t$('.burger-menu-blockmenu').slideUp(200)\r\n\t\t\theaderBurgerMenuClicks = 0\r\n\t\t}\r\n\t\tconsole.log(headerBurgerMenuClicks)\r\n\t})\r\n})\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/burger.js?");

/***/ }),

/***/ "./src/js/modules/featuresType-select.js":
/*!***********************************************!*\
  !*** ./src/js/modules/featuresType-select.js ***!
  \***********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n$(function () {\r\n\tlet featuresHousesTypeArray = [1, 0, 0]\r\n\t$('.features-houses__block').each((index) => {\r\n\t\t$('.features-select').eq(index).fadeOut(0)\r\n\t\t$('.features-select').eq(0).fadeIn(0)\r\n\t\t$('.features-houses__block').eq(index).click(() => {\r\n\t\t\tfeaturesHousesTypeArray[index]++\r\n\t\t\tif (featuresHousesTypeArray[index] === 2) {\r\n\t\t\t\tfeaturesHousesTypeArray[index] = 1\r\n\t\t\t}\r\n\t\t\tconsole.log(featuresHousesTypeArray)\r\n\t\t\tfeaturesHousesTypeArray.forEach((el, arrayIndex) => {\r\n\t\t\t\tif (featuresHousesTypeArray[arrayIndex] === 1 && arrayIndex !== index) {\r\n\t\t\t\t\tconsole.log(arrayIndex)\r\n\t\t\t\t\t$('.features-houses__block').eq(arrayIndex).removeClass('features-houses__block-active')\r\n\t\t\t\t\t$('.features-houses__text').eq(arrayIndex).removeClass('features-houses__text-active')\r\n\t\t\t\t\tlet featuresHousesSvgSrc = $('.features-houses__svg').eq(arrayIndex).attr('src')\r\n\t\t\t\t\tfeaturesHousesSvgSrc = featuresHousesSvgSrc.replace('-green', '')\r\n\t\t\t\t\tconsole.log(featuresHousesSvgSrc)\r\n\t\t\t\t\t$('.features-houses__svg-active').attr('src', `${featuresHousesSvgSrc}`)\r\n\t\t\t\t\t$('.features-houses__svg').eq(arrayIndex).removeClass('features-houses__svg-active')\r\n\t\t\t\t\t$('.features-select').eq(arrayIndex).fadeOut(0)\r\n\t\t\t\t\tfeaturesHousesTypeArray[arrayIndex] = 0\r\n\t\t\t\t}\r\n\t\t\t})\r\n\t\t\t$('.features-houses__block').eq(index).addClass('features-houses__block-active')\r\n\t\t\t$('.features-houses__text').eq(index).addClass('features-houses__text-active')\r\n\t\t\t$('.features-houses__svg').eq(index).addClass('features-houses__svg-active')\r\n\t\t\t$('.features-select').eq(index).fadeIn(200)\r\n\t\t\t$('.features-houses__svg-active').attr('src', `${$('.features-houses__svg-active').attr('src')}-green`)\r\n\t\t})\r\n\t})\r\n})\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/featuresType-select.js?");
...
/***/ "./src/js/modules/headerNavMenu-open.js":
/*!**********************************************!*\
  !*** ./src/js/modules/headerNavMenu-open.js ***!
  \**********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n$(function () {\r\n\tlet headerNavMenuClicks = 0\r\n\t$('.header-nav-menu').slideUp(0)\r\n\t$('.header-nav__text-menu').click(() => {\r\n\t\theaderNavMenuClicks++\r\n\t\tif (headerNavMenuClicks === 1) {\r\n\t\t\t$('.header-nav-menu').slideDown(200)\r\n\t\t}\r\n\t\tif (headerNavMenuClicks === 2) {\r\n\t\t\t$('.header-nav-menu').slideUp(200)\r\n\t\t\theaderNavMenuClicks = 0\r\n\t\t}\r\n\t})\r\n})\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/headerNavMenu-open.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var swiper_bundle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper/bundle */ \"./node_modules/swiper/swiper-bundle.mjs\");\n// import Swiper bundle with all modules installed\r\n\r\n\r\n// init Swiper:\r\nconst swiperHouses = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.swiperhouses', {\r\n\t// Optional parameters\r\n\tdirection: 'horizontal',\r\n\tloop: true,\r\n\tslidesPerView: 2,\r\n\tspaceBetween: 24,\r\n\t// If we need pagination\r\n\tpagination: {\r\n\t\tel: '.swiper-pagination',\r\n\t},\r\n\r\n});\r\nconst swiperFeatures = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.swiperfeatures', {\r\n\t// Optional parameters\r\n\tdirection: 'horizontal',\r\n\tloop: true,\r\n\tslidesPerView: 4,\r\n\tnavigation: {\r\n\t\tnextEl: '.swiper-button-next',\r\n\t\tprevEl: '.swiper-button-prev',\r\n\t},\r\n\tbreakpoints: {\r\n\t\t501: {\r\n\t\t\tspaceBetween: 40\r\n\t\t},\r\n\t\t0: {\r\n\t\t\tspaceBetween: 24\r\n\t\t}\r\n\t}\r\n});\r\nconst swiperAbout = new swiper_bundle__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('.swiperabout', {\r\n\t// Optional parameters\r\n\tdirection: 'horizontal',\r\n\tloop: true,\r\n\tslidesPerView: 3,\r\n\tpagination: {\r\n\t\tel: '.swiper-pagination',\r\n\t},\r\n\tbreakpoints: {\r\n\t\t601: {\r\n\t\t\tspaceBetween: 56\r\n\t\t},\r\n\t\t0: {\r\n\t\t\tspaceBetween: 36\r\n\t\t}\r\n\t}\r\n});\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/swiper.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n$(function () {\r\n\tlet reviewVideoPlayClicks = 0\r\n\t$('.review-video-play').click(() => {\r\n\t\t$('.video').css({\r\n\t\t\t'width': '150%'\r\n\t\t})\r\n\t\treviewVideoPlayClicks++\r\n\t\tif (reviewVideoPlayClicks === 1) {\r\n\t\t\t$('.video').get(0).play()\r\n\t\t\t$('.review-video-play__svg').eq(0).attr('src', $('.review-video-play__svg').eq(0).attr('src').replace('play', 'pause'))\r\n\t\t}\r\n\t\tif (reviewVideoPlayClicks === 2) {\r\n\t\t\t$('.video').get(0).pause()\r\n\t\t\t$('.review-video-play__svg').eq(0).attr('src', $('.review-video-play__svg').eq(0).attr('src').replace('pause', 'play'))\r\n\t\t\treviewVideoPlayClicks = 0\r\n\t\t}\r\n\t})\r\n})\n\n//# sourceURL=webpack://gulp-2022/./src/js/modules/videoPlay.js?");
